...
static PyMethodDef __pyx_mdef_9wordcloud_20query_integral_image_1query_integral_image = {"query_integral_image", (PyCFunction)__pyx_pw_9wordcloud_20query_integral_image_1query_integral_image, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_9wordcloud_20query_integral_image_1query_integral_image(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("query_integral_image (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_size_x)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("query_integral_image", 1, 4, 4, 1); __PYX_ERR(0, 7, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_size_y)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("query_integral_image", 1, 4, 4, 2); __PYX_ERR(0, 7, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_random_state)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("query_integral_image", 1, 4, 4, 3); __PYX_ERR(0, 7, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "query_integral_image") < 0)) __PYX_ERR(0, 7, __pyx_L3_error)
      }
    ...
    __pyx_v_integral_image = __Pyx_PyObject_to_MemoryviewSlice_dsds_unsigned_int(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_integral_image.memview)) __PYX_ERR(0, 7, __pyx_L3_error)
    __pyx_v_size_x = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_size_x == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 7, __pyx_L3_error)
    __pyx_v_size_y = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_size_y == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 7, __pyx_L3_error)
    __pyx_v_random_state = values[3];
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("query_integral_image", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 7, __pyx_L3_error)
  __pyx_L3_error:;
 ...
 */
  ...
  /* "wordcloud/query_integral_image.pyx":12
 *     cdef int y = integral_image.shape[1]
 *     cdef int area, i, j
 *     cdef int hits = 0             # <<<<<<<<<<<<<<
 * 
 ...
 *                 hits += 1
 */
      __pyx_t_11 = (__pyx_v_i + __pyx_v_size_x);
      __pyx_t_12 = __pyx_v_j;
      __pyx_t_13 = __pyx_v_i;
      __pyx_t_14 = (__pyx_v_j + __pyx_v_size_y);
      __pyx_v_area = (__pyx_v_area - ((*((unsigned int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_integral_image.data + __pyx_t_11 * __pyx_v_integral_image.strides[0]) ) + __pyx_t_12 * __pyx_v_integral_image.strides[1]) ))) + (*((unsigned int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_integral_image.data + __pyx_t_13 * __pyx_v_integral_image.strides[0]) ) + __pyx_t_14 * __pyx_v_integral_image.strides[1]) )))));
 ...
 *         return None
 */
  __pyx_t_15 = ((!(__pyx_v_hits != 0)) != 0);
  if (__pyx_t_15) {

    /* "wordcloud/query_integral_image.pyx":23
 *     if not hits:
 *         # no room left
 *         return None             # <<<<<<<<<<<<<<
 ...
 *     for i in xrange(x - size_x):
 */
  __pyx_t_17 = __Pyx_PyObject_GetAttrStr(__pyx_v_random_state, __pyx_n_s_randint); if (unlikely(!__pyx_t_17)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_17);
  __pyx_t_18 = __Pyx_PyInt_From_int(__pyx_v_hits); if (unlikely(!__pyx_t_18)) __PYX_ERR(0, 25, __pyx_L1_error)
  ...
  if (PyFunction_Check(__pyx_t_17)) {
    PyObject *__pyx_temp[3] = {__pyx_t_19, __pyx_int_0, __pyx_t_18};
    __pyx_t_16 = __Pyx_PyFunction_FastCall(__pyx_t_17, __pyx_temp+1-__pyx_t_1, 2+__pyx_t_1); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 25, __pyx_L1_error)
  ...
  if (__Pyx_PyFastCFunction_Check(__pyx_t_17)) {
    PyObject *__pyx_temp[3] = {__pyx_t_19, __pyx_int_0, __pyx_t_18};
    __pyx_t_16 = __Pyx_PyCFunction_FastCall(__pyx_t_17, __pyx_temp+1-__pyx_t_1, 2+__pyx_t_1); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 25, __pyx_L1_error)
    __Pyx_XDECREF(__pyx_t_19); __pyx_t_19 = 0;
    __Pyx_GOTREF(__pyx_t_16);
    __Pyx_DECREF(__pyx_t_18); __pyx_t_18 = 0;
  } else
  #endif
  {
    __pyx_t_20 = PyTuple_New(2+__pyx_t_1); if (unlikely(!__pyx_t_20)) __PYX_ERR(0, 25, __pyx_L1_error)
    ...
    PyTuple_SET_ITEM(__pyx_t_20, 0+__pyx_t_1, __pyx_int_0);
    __Pyx_GIVEREF(__pyx_t_18);
    PyTuple_SET_ITEM(__pyx_t_20, 1+__pyx_t_1, __pyx_t_18);
    __pyx_t_18 = 0;
    __pyx_t_16 = __Pyx_PyObject_Call(__pyx_t_17, __pyx_t_20, NULL); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 25, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_16);
    __Pyx_DECREF(__pyx_t_20); __pyx_t_20 = 0;
  }
  __Pyx_DECREF(__pyx_t_17); __pyx_t_17 = 0;
  __pyx_t_1 = __Pyx_PyInt_As_int(__pyx_t_16); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 25, __pyx_L1_error)
 ...
 */
      ...
      __pyx_t_23 = (__pyx_v_i + __pyx_v_size_x);
      __pyx_t_24 = (__pyx_v_j + __pyx_v_size_y);
      __pyx_v_area = ((*((unsigned int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_integral_image.data + __pyx_t_21 * __pyx_v_integral_image.strides[0]) ) + __pyx_t_22 * __pyx_v_integral_image.strides[1]) ))) + (*((unsigned int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_integral_image.data + __pyx_t_23 * __pyx_v_integral_image.strides[0]) ) + __pyx_t_24 * __pyx_v_integral_image.strides[1]) ))));
 ...
 *                 hits += 1
 */
      __pyx_t_25 = (__pyx_v_i + __pyx_v_size_x);
      __pyx_t_26 = __pyx_v_j;
      __pyx_t_27 = __pyx_v_i;
      __pyx_t_28 = (__pyx_v_j + __pyx_v_size_y);
      __pyx_v_area = (__pyx_v_area - ((*((unsigned int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_integral_image.data + __pyx_t_25 * __pyx_v_integral_image.strides[0]) ) + __pyx_t_26 * __pyx_v_integral_image.strides[1]) ))) + (*((unsigned int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_integral_image.data + __pyx_t_27 * __pyx_v_integral_image.strides[0]) ) + __pyx_t_28 * __pyx_v_integral_image.strides[1]) )))));
 ...
 *                     return i, j
 */
        __pyx_t_15 = ((__pyx_v_hits == __pyx_v_goal) != 0);
        if (__pyx_t_15) {
 ...
 */
          __Pyx_XDECREF(__pyx_r);
          __pyx_t_16 = __Pyx_PyInt_From_int(__pyx_v_i); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 34, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_16);
          __pyx_t_17 = __Pyx_PyInt_From_int(__pyx_v_j); if (unlikely(!__pyx_t_17)) __PYX_ERR(0, 34, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_17);
 ...
 *     cdef int x = integral_image.shape[0]
 */
  __pyx_tuple__22 = PyTuple_Pack(11, __pyx_n_s_integral_image, __pyx_n_s_size_x, __pyx_n_s_size_y, __pyx_n_s_random_state, __pyx_n_s_x, __pyx_n_s_y, __pyx_n_s_area, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_hits, __pyx_n_s_goal); if (unlikely(!__pyx_tuple__22)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__22);
  __Pyx_GIVEREF(__pyx_tuple__22);
  __pyx_codeobj__23 = (PyObject*)__Pyx_PyCode_New(4, 0, 11, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__22, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_query_integral_image_pyx, __pyx_n_s_query_integral_image, 7, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__23)) __PYX_ERR(0, 7, __pyx_L1_error)
...
static int __pyx_pymod_exec_query_integral_image(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
 ...
 *     cdef int x = integral_image.shape[0]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_9wordcloud_20query_integral_image_1query_integral_image, NULL, __pyx_n_s_wordcloud_query_integral_image); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_query_integral_image, __pyx_t_1) < 0) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init wordcloud.query_integral_image", 0, __pyx_lineno, __pyx_filename);
    }
